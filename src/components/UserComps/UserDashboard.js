...
class UserDashboard extends Component {
	...
	render() {
		...
		return localStorage.getItem("auth_token") ? (
			<Fragment>
				<section className="hero is-success is-fullheight" style={{ backgroundColor: "#000066" }}>
					<div className="hero-head">
						<header className="navbar">
							<div className="container">
								...
								<nav id="navbarMenuHeroA" className="navbar-menu">
					...
					<div className="hero-body" style={{ backgroundColor: "#000066" }}>
						<div
							...
							<Route path={`${this.props.match.url}/books`} component={UserBooks} />

							{/*route for user to view books they borrowed*/}
							<Route path={`${this.props.match.url}/borrowed-books`} component={UserLibrary} />

							{/*route for user to view history of borrowed books*/}
							<Route path={`${this.props.match.url}/history`} component={UserBookHistory} />
